...
//       <div className="navbar bg-base-100 max-w-8xl mx ">
//         <div className="flex-1">
//           <Link
//             to="/"
//             className="btn btn-ghost normal-case text-3xl font-black text-accent-content"
//           >
//             <AiFillShopping />
//             Smit Clothing & Shoes
//           </Link>
...
//         <div className="topbar border-b border-gray-600 ">
//         <ul>
//           <li>
//             <FaHeadphones className="text-l max-sm:text-lg text-accent-content" />
//             <span className="text-xl max-sm:text-lg text-accent-content">
//               +91 9898924567
//             </span>
//           </li>
//           <li>
//             <FaRegEnvelope className="text-l max-sm:text-lg text-accent-content" />{" "}
...
//   return (
//     <>
//       <div className="navbar bg-base-100 max-w-8xl mx-auto flex flex-col">
//         <div className="flex justify-between w-full items-center">
//           <div className="topbar flex items-center">
//             <FaHeadphones className="text-l max-sm:text-lg text-accent-content" />
//             <span className="text-xl max-sm:text-lg text-accent-content ml-2">
//               +91 9898924567
//             </span>
//             <FaRegEnvelope className="text-l max-sm:text-lg text-accent-content ml-6" />
//             <span className="text-2xl max-sm:text-lg text-accent-content ml-2">
//               support@smit.com
//             </span>
//           </div >
//           <Link to="/" className="btn btn-ghost normal-case text-5xl font-black text-accent-content mx-auto">
//             <AiFillShopping />
//             Smit Clothing & Shoes
//           </Link>
...
//       <div className="navbar-bottom-menu border-y border-black-800">
//         <div className="drawer">
//           <input id="my-drawer" type="checkbox" className="drawer-toggle" />
//           <div className="drawer-content">
//             <label htmlFor="my-drawer" className="btn drawer-button">
      ...
      <div className="navbar bg-base-100 max-w-8xl mx-auto flex flex-col">
        <div className="flex justify-between w-full items-center">
          ...
          <div className="flex-1 text-center">
            <Link to="/" className="btn btn-ghost normal-case text-5xl font-black text-accent-content">
              <AiFillShopping />
              Smit Clothing & Shoes
            </Link>
          </div>
